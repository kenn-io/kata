...
func TestFederationHelpIsVisible(t *testing.T) {
	...
	assert.Contains(t, out, "rewrite-author")
}

func TestFederationRewriteAuthorCLIReportsCounts(t *testing.T) {
	...
	out := runCLI(t, env, dir, "federation", "rewrite-author",
		"--from", from, "--to", to)
...
func TestFederationRewriteAuthorCLIJSONCounts(t *testing.T) {
	env, dir, pid := setupCLIWorkspace(t)
	ctx := context.Background()
	from, to := "old-agent", "new-agent"
	...
	out := runCLI(t, env, dir, "--json", "federation", "rewrite-author",
		"--from", from, "--to", to)
...
func TestFederationRewriteAuthorCLIRejectsEmptyTo(t *testing.T) {
	env, dir, _ := setupCLIWorkspace(t)

	_, err := runCLICapture(t, env, dir, "federation", "rewrite-author",
		"--from", "old-agent", "--to", "   ")
