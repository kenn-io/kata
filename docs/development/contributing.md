...
under `docs/superpowers/specs` are useful for context, but they should not be
published wholesale because some decisions have changed during implementation.
